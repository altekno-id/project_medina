<div>
    ...
    <form wire:submit="formSubmit">
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="card">
                    <h5 class="card-header">Edit Pembangunan Unit</h5>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input wire:model="form.harga_unit" type="text" class="form-control @error('form.harga_unit') is-invalid @enderror" placeholder="Tulis...">
